...
describe('Solution symmetry',function () {
    ...
    describe('Checking values',function () {
        ...
        it('should return true for [5,hi,{a:5},new Date(),5,hi,{a:5}]',function () {
            expect(isSymmetric([5,'hi',{a:5},new Date(),{a:5},'hi',5])).to.be.true
        });
        it('should return false for [5,hi,{a:5},new Date(),5,hi,{a:5}]',function () {
